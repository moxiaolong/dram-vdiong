...
![img](/images/netpoll/slide_13.jpg)
...
![img](/images/netpoll/5-io-model.jpg)
...
Linux 下，我们可以通过 `fcntl` 系统调用来设置 `O_NONBLOCK` 标志位，从而把 socket 设置成 Non-blocking。当对一个 Non-blocking socket 执行读操作时，流程是这个样子： ![img](/images/netpoll/non-blocking-io.png)
...
![img](/images/netpoll/epoll-principle.png)
...
![img](/images/netpoll/go-network-server.png)
...
![img](/images/netpoll/netpoller-goroutines-scheduling.png)
...
![img](/images/netpoll/goroutine-scheduler-model.png)
...
![multireactorsthreadpool.png](/images/netpoll/multi-reactors-thread-pool.png)