...
一切的程序只能串行发生。
![img1.png](/images/go/gmp/img1.png)
早期的单进程操作系统，面临 2 个问题：
...
### (2) 多进程 / 线程时代有了调度器需求
![img2.png](/images/go/gmp/img2.png)
...
![img.png](/images/go/gmp/img3.png)
...
![img.png](/images/go/gmp/img4.png)

这样，我们再去细化去分类一下，内核线程依然叫 “线程 (thread)”，用户线程叫 “协程 (co-routine)”.

![img.png](/images/go/gmp/img5.png)
...
![img.png](/images/go/gmp/img6.png)
...
![img.png](/images/go/gmp/img7.png)

> **M:N 关系**

M 个协程绑定 1 个线程，是 N:1 和 1:1 类型的结合，克服了以上 2 种模型的缺点，但实现起来最为复杂。

![img.png](/images/go/gmp/img8.png)
...
![img.png](/images/go/gmp/img9.png)

下面我们来看看被废弃的 golang 调度器是如何实现的？

![img.png](/images/go/gmp/img10.png)
...
![img.png](/images/go/gmp/img11.png)

**Processor，它包含了运行 goroutine 的资源**，如果线程想运行 goroutine，必须先获取 P，P 中还包含了可运行的 G 队列。

### (1) GMP 模型
在 Go 中，**线程是运行 goroutine 的实体，调度器的功能是把可运行的 goroutine 分配到工作线程上**。
![img.png](/images/go/gmp/img12.png)
...
### (3) go func () 调度流程
![img.png](/images/go/gmp/img13.png)
从上图我们可以分析出几个结论：
...
![img.png](/images/go/gmp/img14.png)
特殊的 M0 和 G0
...
![img.png](/images/go/gmp/img15.png)

![img.png](/images/go/gmp/img16.png)

**G 信息**
点击 Goroutines 那一行可视化的数据条，我们会看到一些详细的信息。

![img.png](/images/go/gmp/img17.png)
...
![img.png](/images/go/gmp/img18.png)

一共有两个 M 在程序中，一个是特殊的 M0，用于初始化使用，这个我们不必讨论。

**P 信息**
![img.png](/images/go/gmp/img19.png)
...
我们在来看看上面的 M 信息。
 ...
 ![img.png](/images/go/gmp/img20.png)

我们会发现，确实 G18 在 P0 上被运行的时候，确实在 Threads 行多了一个 M 的数据，点击查看如下：

![img.png](/images/go/gmp/img21.png)
...
![img.png](/images/go/gmp/img22.png)
...
![img.png](/images/go/gmp/img23.png)
...
![img.png](/images/go/gmp/img24.png)
...
![img.png](/images/go/gmp/img25.png)
...
![img.png](/images/go/gmp/img26.png)
...
![img.png](/images/go/gmp/img27.png)
...
![img.png](/images/go/gmp/img28.png)
...
![img.png](/images/go/gmp/img29.png)
...
![img.png](/images/go/gmp/img30.png)
...
![img.png](/images/go/gmp/img31.png)
...
![img.png](/images/go/gmp/img32.png)
